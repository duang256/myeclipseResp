...
<body style="background-color:#df7611; background-image:url(images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
	...
	<c:if test="${obj!=null}">
	     ...
	     <div style="text-align:center">
    		<span style="font-size:13px;color:white;font-weight:bold";>用户名或密码错误</span>
   		 </div>
	</c:if>
    ...
    <c:if test="${reg!=null}">
    	 <div style="text-align:center">
    		<span style="font-size:13px;color:white;font-weight:bold";>注册成功</span>
   		 </div>
	</c:if>
    ...
    <div class="loginbm">版权所有  2014  <a href="http://www.uimaker.com">uimaker.com</a>  仅供学习交流，勿用于任何商业用途，交流QQ：2608194130</div>
